            ...
            <div className="w-full md:w-[40%] flex flex-col px-8 md:px-16 lg:px-24 py-12 h-screen animate-fadeIn">
                ...
                <div className="w-full max-w-md mx-auto flex flex-col gap-[40px]">
                    ...
                    <div className="self-stretch flex flex-col justify-start items-center gap-[16px]">
                        <div className="self-stretch text-[#3B4141] text-[40px] font-['Inter'] font-medium leading-[36px] break-words">Esqueci minha senha</div>
                        <div className="self-stretch opacity-80 text-[#3B4141] text-[20px] font-['Inter'] font-normal leading-[24px] break-words">Insira seu e-mail e enviaremos instruções para redefinir sua senha.</div>
                    </div>
                    ...
                    <div className="self-stretch flex flex-col justify-start items-start gap-[32px]">
                        <div className="self-stretch flex flex-col justify-start items-start gap-[16px]">
                            ...
                            <div className="self-stretch h-[56px] px-[20px] py-[16px] rounded-[4px] border border-[rgba(204,204,204,0.30)] flex justify-start items-center gap-[10px]">
                                <div className="w-[24px] h-[24px] relative overflow-hidden">
                                    <div className="w-[18px] h-[14px] left-[3px] top-[5px] absolute border-[1.33px] border-[#CCCCCC]"></div>
                                    <div className="w-[18px] h-[6px] left-[3px] top-[7px] absolute border-[1.33px] border-[#CCCCCC]"></div>
                                </div>
                                <input
                                    type="email"
                                    value={email}
                            ...
                            <button
                                ...
                                disabled={!email}
                                className={`self-stretch h-[56px] px-[20px] rounded-[4px] flex justify-center items-center gap-[10px] transition-colors ${email ? 'bg-[#F78800] hover:bg-orange-600' : 'bg-gray-300 cursor-not-allowed'}`}
                            >
