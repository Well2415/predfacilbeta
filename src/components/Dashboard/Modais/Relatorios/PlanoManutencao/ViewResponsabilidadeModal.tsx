...
import { Responsabilidade } from '../../../../../hooks/relatorioResponsabilidadesData';

interface ViewResponsabilidadeModalProps {
    onClose: () => void;
    data: Responsabilidade;
}

export function ViewResponsabilidadeModal({ onClose, data }: ViewResponsabilidadeModalProps) {
    return (
        <div className="fixed inset-0 bg-black/50 z-[100] flex items-center justify-center p-4 animate-in fade-in duration-200">
            <div className="w-[600px] bg-white rounded-[8px] shadow-xl flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200">
                {/* Header */}
                <div className="h-[70px] px-[32px] border-b border-[#E1E1E1] flex justify-between items-center shrink-0">
                    <div className="text-[#3B4141] text-[20px] font-bold font-['DM_Sans']">Detalhes da Responsabilidade</div>
                ...
                <div className="p-[32px] flex flex-col gap-[24px] overflow-y-auto custom-scrollbar">
                    <div className="flex flex-col gap-[8px]">
                        <label className="text-[#898D8D] text-[14px] font-medium font-['DM_Sans'] uppercase tracking-wider">Cargo / Função</label>
                    ...
                    <div className="flex flex-col gap-[8px]">
                        <label className="text-[#898D8D] text-[14px] font-medium font-['DM_Sans'] uppercase tracking-wider">Descrição das Atribuições</label>
                        <div className="text-[#3B4141] text-[16px] font-normal font-['DM_Sans'] leading-relaxed whitespace-pre-wrap bg-[#F9FAFB] p-4 rounded-[4px] border border-[#F0F0F0]">
                            {data.descricao}
                        </div>
                    </div>
                </div>
